            ...
            <div className="grid grid-cols-1 gap-5">
              ...
              {loading ? (
                <button
                  disabled={loading}
                  type="submit"
                  className="w-full text-center py-3 rounded bg-gray-800 font-medium text-sm text-white hover:bg-gray-900 transition-all focus:outline-none my-1 flex justify-center gap-2"
                >
                  <img
                ...
                <button
                  type="submit"
                  className="w-full text-center py-3 rounded bg-gray-800 font-medium text-sm text-white hover:bg-gray-900 transition-all focus:outline-none my-1"
                >
